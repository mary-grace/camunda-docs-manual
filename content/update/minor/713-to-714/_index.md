...
1. For developers: [Connect Dependencies](#connect-dependencies)
...
`camunda-connect-core` dependency has been added to the Platform engine (`camunda-engine`) artifact. In case you already have a [Connect]({{< ref "/reference/connect/_index.md#maven-coordinates" >}}) dependencies, please consider consolidating the version of them with one that is shipped with the engine. List of the connect artifacts:
...
That will prevent inconsistencies on the system.
